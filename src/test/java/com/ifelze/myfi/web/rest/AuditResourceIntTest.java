...
import com.ifelze.myfi.Myfi2App;
import com.ifelze.myfi.config.audit.AuditEventConverter;
import com.ifelze.myfi.domain.PersistentAuditEvent;
import com.ifelze.myfi.repository.PersistenceAuditEventRepository;
import com.ifelze.myfi.service.AuditEventService;
...
@SpringBootTest(classes = Myfi2App.class)
@Transactional
